...
-- Send a "Script Started" message if enabled in the config
if Config.EnableStartupMessage then
    sendToDiscord("Hitbox Detection Script Started", "The hitbox detection script has successfully started on the server.", 3066993) -- Green color
end
